...
<p align="center">
  ...
  <p align="center">
   <a href="https://mybinder.org/v2/gh/qiskit-community/prototype-quantum-kernel-training/HEAD?labpath=docs%2Ftutorials%2Fkernel_optimization_using_qkt.ipynb">
...
* `TrainableFidelityQuantumKernel`: Option to handle quantum kernels with trainable parameters.
...
- [Opening an issue](https://github.com/qiskit-community/prototype-quantum-kernel-training/issues) in the repository
- [Starting a conversation on GitHub Discussions](https://github.com/qiskit-community/prototype-quantum-kernel-training/discussions)
